...
data.frame(Etiqueta = 1:10, Variable = colnames(college[, 1:10])) %>%
  t() %>%
  kable(booktab = T, align = "c", longtable = T, caption = "Descripción de etiquetas para el gráfico anterior", row.names = T) %>%
  column_spec(1:10, width = "1.25cm") %>%
  row_spec(1:2, font_size = 7, bold = T) %>%
